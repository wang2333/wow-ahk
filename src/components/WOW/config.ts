...
/** 佳佳正式服一键宏 */
export const color_mappings_JIAJIA_REAL: Record<string, string> = {
  '#23A359': 'CTRL-F2',
  '#3C4835': 'CTRL-F1',
  '#B89EB8': 'CTRL-F4',
  '#B89EB1': 'CTRL-F3',
  ...
  '#E63E74': 'CTRL-NUM9',
  '#686FE6': 'CTRL-NUM0',
  '#DA54F1': 'CTRL-SHIFT-F1',
  '#F8A3E0': 'CTRL-SHIFT-F2',
  '#F3568D': 'CTRL-SHIFT-F3',
  '#F89C9C': 'CTRL-SHIFT-F4',
  '#F4A360': 'CTRL-SHIFT-F5',
  '#FAF8B4': 'CTRL-SHIFT-F6',
  '#AAF46C': 'CTRL-SHIFT-F7',
  '#B4FAC6': 'CTRL-SHIFT-F8',
  '#77F7D7': 'CTRL-SHIFT-F9',
  '#DAC2FA': 'CTRL-SHIFT-F10',
  '#BF6FA5': 'CTRL-SHIFT-F11',
  '#4EA383': 'CTRL-SHIFT-F12',
  '#B6B4F8': 'ALT-SHIFT-F1',
  '#DBB3F9': 'ALT-SHIFT-F2',
  '#F4B1FA': 'ALT-SHIFT-F3',
  '#F9B3E2': 'ALT-SHIFT-F4',
  ...
  '#F9ECB3': 'ALT-SHIFT-F8',
  '#D8F9B7': 'ALT-SHIFT-F9',
  '#C2F9B7': 'ALT-SHIFT-F10',
  '#DAB356': 'ALT-SHIFT-F11',
  '#C769A6': 'ALT-SHIFT-F12',
  '#EED68C': 'ALT-SHIFT-F1',
  '#EEA38C': 'ALT-SHIFT-F2',
  '#EE8C9B': 'ALT-SHIFT-F3',
  '#ED8DBD': 'ALT-SHIFT-F4',
  ...
  '#928FEF': 'ALT-SHIFT-F8',
  '#C473E6': 'ALT-SHIFT-F9',
  '#E87195': 'ALT-SHIFT-F10',
  '#18AEE7': 'ALT-SHIFT-F11',
  '#5792E1': 'ALT-SHIFT-F12',
  '#B7F9F5': 'ALT-CTRL-SHIFT-F1',
  '#B7DDF9': 'ALT-CTRL-SHIFT-F2',
  '#AEC2F7': 'ALT-CTRL-SHIFT-F3',
  '#AEAEF7': 'ALT-CTRL-SHIFT-F4',
  '#8DA0ED': 'ALT-CTRL-SHIFT-F5',
  '#8DB9ED': 'ALT-CTRL-SHIFT-F6',
  '#8DDAED': 'ALT-CTRL-SHIFT-F7',
  '#8DEDD2': 'ALT-CTRL-SHIFT-F8',
  '#8DEDA6': 'ALT-CTRL-SHIFT-F9',
  '#CEED8D': 'ALT-CTRL-SHIFT-F10',
  '#F9E431': 'ALT-CTRL-SHIFT-F11',
  '#D0888A': 'ALT-CTRL-SHIFT-F12',
  '#46E7F9': 'ALT-CTRL-NUM1',
  '#45FABF': 'ALT-CTRL-NUM2',
  '#45FA6D': 'ALT-CTRL-NUM3',
  '#BFFB44': 'ALT-CTRL-NUM4',
  '#FBC444': 'ALT-CTRL-NUM5',
  '#FB7644': 'ALT-CTRL-NUM6',
  '#FB4496': 'ALT-CTRL-NUM7',
  '#FB44F7': 'ALT-CTRL-NUM8',
  '#9644FB': 'ALT-CTRL-NUM9',
  '#488AF7': 'ALT-CTRL-NUM0',
  '#9B84EA': 'CTRL-SHIFT-P',
  '#B984EA': 'CTRL-SHIFT-L',
  '#EA84EA': 'CTRL-SHIFT-O',
  '#EB83B1': 'CTRL-SHIFT-K',

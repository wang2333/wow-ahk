...
-- @class file
-- @name LibRangeCheck-3.0
local MAJOR_VERSION = "WR_LibRangeCheck3"  -- 主版本号
local MINOR_VERSION = 28  -- 次版本号

-- 如果库实例不存在，就创建一个
local lib = _G[MAJOR_VERSION]
if not lib then
    lib = {}
    _G[MAJOR_VERSION] = lib
end

-- 如果库已经加载，并且次版本号不比当前新，就直接返回
if lib.minor and lib.minor >= MINOR_VERSION then
    return
end

...
local classFilename, classId = UnitClassBase("player")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 圣殿骑士的裁决")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 审判")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 荣耀圣令")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 责难")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 狂热")  
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 复仇之怒") 
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 炽热防御者")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 正义防御")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST ")

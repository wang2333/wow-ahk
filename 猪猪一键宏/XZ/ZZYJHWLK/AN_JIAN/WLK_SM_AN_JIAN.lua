...
local MacroButton
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/CAST 大地之力图腾")    
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 风剪")    
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 先祖的召唤")    
    
    MacroButton = CreateFrame("Button", "CN9", UIParent, "SecureActionButtonTemplate");
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 灵魂的召唤")    
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 灼热图腾")  
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast [target=focus] 烈焰震击")   
    
    
    MacroButton = CreateFrame("Button", "N10", UIParent, "SecureActionButtonTemplate");
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast [target=mouseover] 烈焰震击")     

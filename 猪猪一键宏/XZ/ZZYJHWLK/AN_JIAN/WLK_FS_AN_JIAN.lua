...
local MacroButton
    ...
    MacroButton:SetAttribute("macrotext", "/cast 熔岩护甲")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast [target=mouseover] 活动炸弹")
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/use 法力青玉\n/use 法力刚玉")        
    
    MacroButton = CreateFrame("Button", "CF1", UIParent, "SecureActionButtonTemplate");
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 冰霜新星")    
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 霜火之箭")    
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 冲击波")
    
    MacroButton = CreateFrame("Button", "AN3", UIParent, "SecureActionButtonTemplate");
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast [@cursor] 烈焰风暴")    
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cancelaura 隐形术")   
    ...
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 防护冰霜结界")
    
    MacroButton = CreateFrame("Button", "CN8", UIParent, "SecureActionButtonTemplate");
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast 防护火焰结界")
    
    MacroButton = CreateFrame("Button", "CN9", UIParent, "SecureActionButtonTemplate");
    MacroButton:SetAttribute("type", "macro")
    MacroButton:SetAttribute("macrotext", "/cast [target=focus] 炎爆术")
